...
function Weathe() {
    ...
    const [dis,setDis]=useState('hyderabad');
    ...
    <div className='container'>
        ...
        <form  >
                <div className="search"   >
                    ...
                    <input  className="input-field"  placeholder="Enter Location"  onChange={onsea} value={dis}  />  
     ...
     {weather.city.name}&nbsp;&nbsp;
      ...
      <div>Wind Speed</div>
        ...
        <div className="humidity">
          <div style={{fontSize:"1.8rem"}} >{(weather.list[0].main.humidity).toFixed(0)}%</div>
          <div >Humidity</div>
        </div>
